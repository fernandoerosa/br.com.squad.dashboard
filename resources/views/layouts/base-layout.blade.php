                    ...
                    <div class="nk-sidebar-menu" data-simplebar>
                        <ul class="nk-menu">
                            ...
                            <li class="nk-menu-item">
                                <a href="{{route('web.projects.index')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-cpu"></em></span>
                                    <span class="nk-menu-text">{{__('Projects')}}</span>
                                </a>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                ...
                                <li class="dropdown chats-dropdown hide-mb-xs">
                                    <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-toggle="dropdown">
                                        <div class="icon-status icon-status-na"><em class="icon ni ni-comments"></em>
                                            <div class="icon-status icon-st atus-na"><em
                                                    class="icon ni ni-comments"></em>
                                            </div>
                                    </a>
...
<script src="{{asset('/assets/js/charts/chart-ecommerce.js?ver=2.8.0')}}"></script>
<script src="{{asset('/assets/js/libs/jkanban.js?ver=2.8.0')}}"></script>
<script src="{{asset('/assets/js/apps/kanban.js?ver=2.8.0')}}"></script>
</body>
</html>
